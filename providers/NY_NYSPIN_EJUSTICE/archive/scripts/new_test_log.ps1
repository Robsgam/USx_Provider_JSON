# new_test_log.ps1
# Creates a pre-formatted test log stub for a NY_NYSPIN_EJUSTICE live test run.
#
# Usage:
#   powershell.exe -ExecutionPolicy Bypass -File scripts\new_test_log.ps1 `
#     -TestNum T4 -QueryType VehicleRegistration -Combination RVIN `
#     -Description "OOS VIN+State" -Version 1.12 -Phase 03_vehicle [-Form "Vehicle - OOS"]
#
...
#   6. Update docs\NY_NYSPIN_EJUSTICE_STATUS.txt TEST LOG and TEST MATRIX sections.
...
$FORM_LINE = if ($Form) { $Form } else { "[FORM -- e.g., Vehicle - NY / Vehicle - OOS / Person - NY]" }

$TITLE      = "NY_NYSPIN_EJUSTICE -- ${QueryType}Query Phase Log"
...
Write-Host "  6. Update docs\NY_NYSPIN_EJUSTICE_STATUS.txt -- TEST LOG and TEST MATRIX."
Write-Host ""
