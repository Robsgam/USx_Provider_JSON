# inspect_layout.ps1
# Quick layout inspection tool for NY_NYSPIN_EJUSTICE.json
...
#   powershell.exe -ExecutionPolicy Bypass -File scripts\inspect_layout.ps1 -EntityLabel "Vehicle - OOS"
#   powershell.exe -ExecutionPolicy Bypass -File scripts\inspect_layout.ps1 -EntityLabel "Person - NY" -LayoutVariant CAD_DISPATCH

param(
    [string]$EntityLabel   = "Vehicle - NY",
