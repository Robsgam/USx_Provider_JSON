...
# Builds OR_LEDS_BASE.json from source\OR_LEDS.xml (metadata v5) + HIDLE.json.
#
...
$OUTREAD  = "$DIR\OR_LEDS_BASE_READABLE.json"
    ...
    @{
        ...
        rows  = @(
            ...
            @{ id = 'ROW_PER_5'; cols = @('6','6'); fields = @(
                @{ id = 'imageIndicator_Input';          node = Inp 'imageIndicator'          'Image (Y)' '1' 'ROW_PER_5' @{ initialValue = 'Y' } }
...
# =====================================================================
# BUNDLE 3: RMS (from HIDLE, with OR patches)
# Patches: 1, 3, 6, 7, 8
# =====================================================================
