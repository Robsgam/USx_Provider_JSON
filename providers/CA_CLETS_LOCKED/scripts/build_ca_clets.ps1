...
# DH-suffix fields: operatorLicenseNumberDH, caRequestPurposeCodeDH,
    ...
    @{
        ...
        rows  = @(
            ...
            @{ id = 'ROW_PER_4'; cols = @('6','6'); fields = @(
                ...
                @{ id = 'caRequestPurposeCodeDH_Input';  node = Inp 'caRequestPurposeCodeDH' 'Purpose Code (DH)' '1' 'ROW_PER_4' @{ initialValue = 'C' } }
            )}
