...
$OUTREAD  = "$DIR\CA_VENTURA_COUNTY_MC_READABLE.json"
...
$entitiesBundle = [PSCustomObject]@{
    ...
    description    = 'Entity form configurations for CA_VENTURA_COUNTY MC'
    name           = 'ENTITIES'
    type           = 'BUNDLE'
...
Write-Host "Built CA_VENTURA_COUNTY_MC.json v${Version}"
