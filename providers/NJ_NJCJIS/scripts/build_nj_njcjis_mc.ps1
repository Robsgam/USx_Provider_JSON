...
#     VehicleReg: autoSelect=true + queriesToDeselect=[VehicleStolenQuery]
#     (default, deselects Stolen)
# =====================================================================
