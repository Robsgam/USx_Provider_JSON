...
# Builds NJ_NJCJIS_BASE_PLATE_TEST.json from source\NJ_NJCJIS.xml (2026-04-28 metadata) + HIDLE.json.
#
...
$OUT = "$DIR\NJ_NJCJIS_BASE_PLATE_TEST.json"
...
# =====================================================================
# Patch 7: RMS autoSelect=true on both QIDMs
# =====================================================================
...
Push-Location $DIR
git add "NJ_NJCJIS_BASE_PLATE_TEST.json" `
