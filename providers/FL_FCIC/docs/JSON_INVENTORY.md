...
| File | Version | Status | Notes |
|------|---------|--------|-------|
| FL_FCIC_BASE.json | v3.8 | Current | 102P/0F/0W/0LIM. RegistrationStateDH isolates DH State from DL routing. |
| FL_FCIC_MC.json | v3.8 | Current | 102P/0F/0W/0LIM. MC variant. |
