# new_test_log.ps1
# Creates a pre-formatted test log stub for a LA_LETTS_OFML live test run.
#
# Usage:
#   powershell.exe -ExecutionPolicy Bypass -File scripts\new_test_log.ps1 `
#     -TestNum T1 -QueryType VehicleRegistration -Combination RVEH `
#     -Description "LA Plate" -Version 1.0 -Phase 01_standup [-Form "Vehicle"]
#
...
$TITLE     = "LA_LETTS_OFML -- ${QueryType}Query Phase Log"
...
Write-Host "  6. Update archive\docs\LA_LETTS_OFML_STATUS.txt -- TEST LOG and TEST MATRIX."
Write-Host ""
