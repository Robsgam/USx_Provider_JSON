# new_test_log.ps1
# Creates a pre-formatted test log stub for a LA_LEMS live test run.
#
# Usage:
...
$TITLE     = "LA_LEMS -- ${QueryType}Query Phase Log"
...
Write-Host "  6. Update archive\docs\LA_LEMS_STATUS.txt -- TEST LOG and TEST MATRIX."
Write-Host ""
