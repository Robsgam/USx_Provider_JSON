# validate_LA_LEMS.ps1
# Structural validator for LA_LEMS_BASE.json
#
# Checks performed:
...
#
# Usage:
#   powershell.exe -ExecutionPolicy Bypass -File scripts\validate_LA_LEMS.ps1
#   powershell.exe -ExecutionPolicy Bypass -File scripts\validate_LA_LEMS.ps1 -JsonFile "path\to\other.json"

param(
    [string]$JsonFile = "$PSScriptRoot\..\LA_LEMS_BASE.json"
)
...
Write-Host ""
Write-Host "=== LA_LEMS Validator ===" -ForegroundColor White
