...
Full reference: `knowledge-base/PLATFORM_CONSTRAINTS.txt` (22 APs + 30 LIMITATIONs + 1 CAPABILITY, non-contiguous AP #2-#27 / LIMITATION #1-#43 / CAPABILITY #44, with cross-reference index).
...
| **What anti-patterns apply?** | `knowledge-base/PLATFORM_CONSTRAINTS.txt` (22 APs + 30 LIMITATIONs + 1 CAPABILITY, non-contiguous AP #2-#27 / LIMITATION #1-#43 / CAPABILITY #44) | Memory, training data |
