...
## Tools (101 scripts + 18 shared modules in `tools/`, + `tools/_probes/` (3 graduated ad-hoc probes) + `tools/config/` (5 JSON reference tables) + 3 archived tools in `tools/_archive/`)
