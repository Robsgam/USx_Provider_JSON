...
Full reference: `knowledge-base/PLATFORM_CONSTRAINTS.txt` (27 APs + 25 LIMITATIONs, non-contiguous #1-#38, with cross-reference index).
...
| **What anti-patterns apply?** | `knowledge-base/PLATFORM_CONSTRAINTS.txt` (27 APs + 25 LIMITATIONs, non-contiguous #1-#38) | Memory, training data |
