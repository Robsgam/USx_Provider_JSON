...
## Provider Status (updated 2026-06-08)
...
| NY_NYSPIN_EJUSTICE | providers/NY_NYSPIN_EJUSTICE/ | v2.2 | 80P/0F/0W/0LIM | 7 cards (Veh 1, Per 3+2 fields, Gun 1, Art 1, Boat 1), 16 combos, 7 QIDMs, DGRP (DL Name Search), DH OOS combos (DALHOUT/DALLOUT + purposeCodeDH/requestorDH), DH-suffix+one-directional queriesToDeselect, CAD defaults all 16 combos, State no-default (LIMIT #30) |
