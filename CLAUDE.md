...
Full reference: `knowledge-base/PLATFORM_CONSTRAINTS.txt` (22 APs + 30 LIMITATIONs, non-contiguous AP #2-#27 / LIMITATION #1-#43, with cross-reference index).
...
| **What anti-patterns apply?** | `knowledge-base/PLATFORM_CONSTRAINTS.txt` (22 APs + 30 LIMITATIONs, non-contiguous AP #2-#27 / LIMITATION #1-#43) | Memory, training data |
