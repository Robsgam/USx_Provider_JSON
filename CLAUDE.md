...
| CA_eSUN | providers/CA_eSUN/ | v1.2 | 69P/0F/3W/5LIM (BASE) 69P/0F/3W/5LIM (MC) BUILT | CaRequestPurposeCode (visible Inp), VP owner search, gun-by-name, Attention handler, MC multi-card (14 cards) |
...
| OH_LEADS | providers/OH_LEADS/ | v1.1 | 75P/0F/4W/4LIM (BASE) 75P/0F/3W/4LIM (MC) BUILT | 6 basic queries, 9 VehReg combos, BMVIMS, owner search (RN), MC multi-card (14 cards) |
...
| OR_LEDS | providers/OR_LEDS/ | v1.1 | 58P/0F/3W/1LIM (BASE) 58P/0F/2W/1LIM (MC) BUILT | 5 basic queries (no DH), invented keyRefs, MC multi-card (11 cards) |
