...
| CA_CLETS | providers/CA_CLETS/ | v1.3 | 63P/0F/3W/5LIM (BASE) 67P/0F/1W/7LIM (MC) import PENDING | CaRequestPurposeCode, LIMITATION #30, 2-QIDM co-fire (DL+DH), MC cross-entity, no ImageIndicator, 6 basic queries only |
