...
## Tools (103 scripts + 18 shared modules in `tools/`, + `tools/_probes/` (8 graduated ad-hoc probes) + `tools/config/` (6 JSON reference tables) + 3 archived tools in `tools/_archive/`)
