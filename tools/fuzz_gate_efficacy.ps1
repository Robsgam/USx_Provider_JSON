...
if ($survivors.Count) {
    ...
    Emit '  a gate SHOULD own. Harmless-by-construction edits (an any[] addition the devdoc already' 'DarkGray'
    Emit '  lists as optional; reordering two combos that can never both match) survive correctly.' 'DarkGray'
