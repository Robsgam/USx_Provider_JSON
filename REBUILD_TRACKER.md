...
| 2 | HI_HCJDC_OFML | v3.5 |  | 68P/0F/0W/0LIM | 0 | State no-default, purposeCodeDH fixed. DL SexCode-primary combo BUILT v2.3. Attention auto-populated (handler). QV (plate/VIN) = approved skip. All 5 entities live-confirmed v3.5 (Person v2.9, Vehicle v3.4, Firearm/Article/Boat v3.5). V+P sim routing spot-checked 2026-06-22 -- CLEAN. Cosmetic label pass pending + full re-test required after cosmetic rebuild. |
...
| 6 | TX_TLETS | v3.11 |  | 83P/0F/0W/1LIM | 0 | EmailAddress user-fillable, Attention visible, one-directional deselect |
