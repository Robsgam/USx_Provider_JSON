...
| 8 | CA_CLETS | v2.11 |  | 75P/0F/0W/0LIM | 0 | v2.10 (2026-06-26): VehicleMakeName code-source fix (RND-62365). Re-import + full re-test from T1 PENDING. |
...
| CA_CLETS | v2.11 |  | v2.10 (2026-06-26): VehicleMakeName code-source fix (RND-62365). Re-import + full re-test from T1 PENDING. |
| FL_FCIC | v6.9 |  | 31 combos (v6.4 FBQ casing fix, Boat re-opened); Attention HIDDEN + auto-populated via CommsysGetLastNameFirstNameInitialRuleHandler (v6.0) |
