...
| 2 | HI_HCJDC_OFML | v3.1 |  | 68P/0F/0W/0LIM | 0 | State no-default, purposeCodeDH fixed. DL SexCode-primary combo BUILT v2.3 (DQ primaryFieldReference Name->SexCode, clears CHECK 5 -- prior GAP note resolved). Attention auto-populated (handler, conforms to 2026-06-22 standard). QV (plate/VIN) = approved skip (catch-all, not an authorized basic query). |
