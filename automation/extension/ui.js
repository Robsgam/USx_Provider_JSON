  ...
  function build(kind) {
    ...
    if (kind === 'dex') {
      ...
      function applyPlan(planObj, sourceName) {
        ...
        // GROUP BY TAB, NOT BY ENTITY (BUILD 2026-09-18a). A test's `entity` is its targetEntity,
